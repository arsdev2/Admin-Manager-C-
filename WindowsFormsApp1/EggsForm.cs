...
namespace WindowsFormsApp1
{
    ...
    {
        private string sqlScript = "SELECT egg_id, egg_name, date, bird_name, calories FROM eggs left join birds on birds.bird_id=eggs.bird_id";
        ...
        private void onLoad(object sender, EventArgs e)
        {
            ...
            DBManager.bindingSource.DataSource = DBManager.performSql(sqlScript);
        ...
        private void onIdClick(object sender, EventArgs e)
        {
            ...
            caloriesCountSortButton.Checked = false;
            sortByColumnName("egg_id");
        }
        ...
        private void датаToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            caloriesCountSortButton.Checked = false;
            sortByColumnName("date");
        }

        private void кстьКалорійToolStripMenuItem_Click(object sender, EventArgs e)
        {
            idSortButton.Checked = false;
            nameSortButton.Checked = false;
            dateSortButton.Checked = false;
            caloriesCountSortButton.Checked = true;
            sortByColumnName("calories");
        }
